...
function filtrar(filtro) {
  var boxListaDicas = document.getElementById("boxListaDicas");
  var strHtml = "";
  ...
  if (filtro == "curiosidades") {
    for (i = 0; i < objDicasCuriosidades.dicasCuriosidades.length; i++) {
      if (objDicasCuriosidades.dicasCuriosidades[i].name != "" && objDicasCuriosidades.dicasCuriosidades[i].type == "curiosidades") {
        strHtml += `
        <div class="boxPetshopLista" onclick="detalhes(${i})">
        <div class="boxInfo">
        <label>Nome:</label>
        <label>${objDicasCuriosidades.dicasCuriosidades[i].name}</label>
        <h4>Tipo: ${objDicasCuriosidades.dicasCuriosidades[i].type}</h4>
        </div>
        </div>
        `;
      }
  ...
  if (filtro == "dicas") {
    for (i = 0; i < objDicasCuriosidades.dicasCuriosidades.length; i++) {
      if (objDicasCuriosidades.dicasCuriosidades[i].name != "" && objDicasCuriosidades.dicasCuriosidades[i].type == "dicas") {
        strHtml += `
        <div class="boxPetshopLista" onclick="detalhes(${i})">
        <div class="boxInfo">
        <label>Nome:</label>
  ...
  boxListaDicas.innerHTML = strHtml;
}
